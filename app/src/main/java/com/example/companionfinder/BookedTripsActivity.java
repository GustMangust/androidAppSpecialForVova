...
public class BookedTripsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.booked_trips_activity);
        ...
        List<Integer> listTripIds = new ArrayList<Integer>(db.tripDao().getTripIds(userId).length);
        for (int i : db.tripDao().getTripIds(userId))
        {
            listTripIds.add(i);
        }


        trips = DatabaseUtility.GetActualTrips(getApplicationContext(),false,false).stream().filter(x-> listTripIds.contains(x.tripId)).collect(Collectors.toList());
    ...
    public class TripListAdapter extends BaseAdapter {
        ...
        public View getView(int pos, View convertView, ViewGroup viewGroup) {
            ...
            cost.setText(Double.toString(trips.get(pos).costForUser)+ " BYN");
